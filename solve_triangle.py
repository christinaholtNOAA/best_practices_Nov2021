...
def apply_pythagorean_theorem(hypotenuse, leg_a, leg_b):
...
def apply_trig_functions(unknown, opposite, adjacent, hypotenuse, theta):
...
def main(clargs):
    ...
    if not solvable:
        print(f'There is not enough information to solve this',
                'triangle.')
        exit(1)
...
def parse_args():
    ...
    parser.add_argument('--hypotenuse', help="Lenght of hypotenuse",
            type=int)
    parser.add_argument('--theta', help="Angle between two sides",
            type=int)

    help_str = ("Length of one leg of the triangle. If --theta argument ",
    "is provided, this should be the length of the side adjacent to ",
    "angle identified.")
    parser.add_argument('--adjacent', help=''.join(help_str), type=int)

    help_str = ["Length of one leg of the triangle. If --theta argument ",
    "is provided, this should be the length of the side opposite the ",
    "angle identified."]
    parser.add_argument('--opposite', help=''.join(help_str), type=int)

    help_str = "Choice of which unknown to be determined."
    parser.add_argument('--unknown', choices=['opposite',
    'adjacent', 'hypotenuse', 'theta'], help=help_str)
